...
![logo](https://github.com/Harris-Majeed/House-Price-Prediction/blob/main/Output/Screenshot%202023-05-16%20041823.png)
...
```
git clone https://github.com/Harris-Majeed/Spam-Email-Detection.git
```
